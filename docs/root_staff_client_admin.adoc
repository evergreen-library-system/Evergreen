...
include::admin_initial_setup/lsa-closed.adoc[]

include::admin_initial_setup/lsa-standing_penalties.adoc[]
...
Needs to be written.  There is a Pre-cat Item Circ Lib OU setting.

Non-cataloged item settings
^^^^^^^^^^^^^^^^^^^^^^^^^^^

Needs to be written.  This is about Local Admin > Non-cataloged item type.
