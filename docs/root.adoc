...
include::RELEASE_NOTES_2_11.adoc[]
...
include::admin/staff_client-login.adoc[]

include::admin/staff_client-button_bar_toolbar.adoc[]

include::admin/staff_client-sticky_settings.adoc[]

include::admin/staff_client-tab_buttons.adoc[]

include::admin/staff_client-double_clicking.adoc[]

include::admin/staff_client-patron_border.adoc[]

include::admin/staff_client-sorting_columns.adoc[]
...
include::admin/workstation_admin_customizable_toolbar.adoc[]
...
include::circulation/circulating_items.adoc[]

include::circulation/holds.adoc[]

include::circulation/booking.adoc[]

include::circulation/circulation_patron_records.adoc[]
