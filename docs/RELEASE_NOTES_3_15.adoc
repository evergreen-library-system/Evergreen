...
The other bug fixed in this release is https://bugs.launchpad.net/evergreen/+bug/2153879[Bug 2150054] - Patron Search Not Sorting as Expected
...
Normal upgrade procedures can be used for this security release. We recommend that all services and Apache are restarted after installation.
...
* Adds author tests to verify that DB update scripts assert their DB revision number correctly (https://bugs.launchpad.net/evergreen/+bug/2083949[Bug 2083949])
...
* Updates Circulation events so that they no longer change editor and edit_date on items, except for floating items when the circulation library changes. (https://bugs.launchpad.net/evergreen/+bug/2055690[Bug 2055690])
...
* Replaces physical left/right properties with CSS logical properties in OPAC HTML templates (https://bugs.launchpad.net/evergreen/+bug/1687031[Bug 1687031])
...
This release contains bug fixes and documentation fixes improving on Evergreen 3.15.10
...
The following organizations sponsored development in the 3.15.11 release of Evergreen:
