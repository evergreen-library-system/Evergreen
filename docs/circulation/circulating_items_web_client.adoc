...
6) If the item is not in a state acceptable for hold/transit (for instance, it is damaged), select the line of the item, and choose Cancel Transit from the Actions menu.  The item will then have a status of Canceled Transit rather than In Transit.
