...
image::media/carousel1.png[Book carousel on public catalog front screen] 
...
image::media/carousel2.png[Carousel Types configuration screen]
...
image::media/carousel3.png[Carousel Types Editor screen]
...
image::media/carousel4.png[Carousels configuration screen]
...
image::media/carousel5.png[Carousel editor screen]
...
image::media/carousel6.png[Record Bucket Actions button - Create Carousel from Bucket]
...
+
image::media/carousel7.png[Actions button on Record Summary page - Add to Carousel] 
+
...
image::media/carousel8.png[Carousel mapping editor screen]
