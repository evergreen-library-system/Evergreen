...
This release contains bug fixes and documentation fixes improving on Evergreen 3.13.10.
...
We would like to thank the following individuals who contributed code, testing, documentation, and patches to the 3.13.11 point release of Evergreen:
