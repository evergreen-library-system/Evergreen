...
~~~~~~~~~~~~~~~~~~~~~~
  ...
  * **Linux**: Evergreen 3.0.10 has been tested on Debian Stretch (9.0),
...
. As the *opensrf* user, download and extract Evergreen 3.0.10:
+
[source, bash]
-----------------------------------------------
wget https://evergreen-ils.org/downloads/Evergreen-ILS-3.0.10.tar.gz
tar xzf Evergreen-ILS-3.0.10.tar.gz
-----------------------------------------------
+
[NOTE]
...
[source, bash]
---------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.0.10
---------------------------------------------
+
...
------------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.0.10
make STAFF_CLIENT_STAMP_ID=rel_3_0_10 install
------------------------------------------------------------
+
...
rm server
ln -sf rel_3_0_10/server server
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.0.10/Open-ILS/examples/apache/eg_startup /etc/apache2/eg_startup
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.0.10/Open-ILS/examples/apache/eg_vhost.conf /etc/apache2/eg_vhost.conf
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.0.10/Open-ILS/examples/apache/eg.conf /etc/apache2/sites-available/eg.conf
----------------------------------------------------------
...
[source, bash]
----------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.0.10/Open-ILS/src/sql/Pg
psql -U evergreen -h localhost -f version-upgrade/3.0.9-3.0.10-upgrade-db.sql evergreen
----------------------------------------------------------
