...
~~~~~~~~~~~~~~~~~~~~~~
  ...
  * **Linux**: Evergreen 2.12.10 has been tested on Debian Jessie (8.0),
...
. As the *opensrf* user, download and extract Evergreen 2.12.10:
+
[source, bash]
-----------------------------------------------
wget https://evergreen-ils.org/downloads/Evergreen-ILS-2.12.10.tar.gz
tar xzf Evergreen-ILS-2.12.10.tar.gz
-----------------------------------------------
+
[NOTE]
...
[source, bash]
---------------------------------------------
cd /home/opensrf/Evergreen-ILS-2.12.10
---------------------------------------------
+
...
------------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-2.12.10
make STAFF_CLIENT_STAMP_ID=rel_2_12_10 install
------------------------------------------------------------
+
...
rm server
ln -sf rel_2_12_10/server server
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-2.12.10/Open-ILS/examples/apache/eg_startup /etc/apache2/eg_startup
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-2.12.10/Open-ILS/examples/apache/eg_vhost.conf /etc/apache2/eg_vhost.conf
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-2.12.10/Open-ILS/examples/apache/eg.conf /etc/apache2/sites-available/eg.conf
----------------------------------------------------------
...
To upgrade across multiple major versions (e.g. from 2.3.0 to 2.12.10), use
...
- (run all incremental scripts from 2.12.0 to 2.12.10)
...
[source, bash]
----------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-2.12.10/Open-ILS/src/sql/Pg
psql -U evergreen -h localhost -f version-upgrade/2.12.9-2.12.10-upgrade-db.sql evergreen
----------------------------------------------------------
