...
~~~~~~~~~~~~~~~~~~~~~~
  ...
  * **Linux**: Evergreen 2.12.7 has been tested on Debian Jessie (8.0),
...
. As the *opensrf* user, download and extract Evergreen 2.12.7:
+
[source, bash]
-----------------------------------------------
wget https://evergreen-ils.org/downloads/Evergreen-ILS-2.12.7.tar.gz
tar xzf Evergreen-ILS-2.12.7.tar.gz
-----------------------------------------------
+
[NOTE]
...
[source, bash]
---------------------------------------------
cd /home/opensrf/Evergreen-ILS-2.12.7
---------------------------------------------
+
...
rm server
ln -sf rel_2_12_7/server server
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-2.12.7/Open-ILS/examples/apache/eg_startup /etc/apache2/eg_startup
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-2.12.7/Open-ILS/examples/apache/eg_vhost.conf /etc/apache2/eg_vhost.conf
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-2.12.7/Open-ILS/examples/apache/eg.conf /etc/apache2/sites-available/eg.conf
----------------------------------------------------------
...
To upgrade across multiple major versions (e.g. from 2.3.0 to 2.12.7), use
...
- (run all incremental scripts from 2.12.0 to 2.12.7)
...
[source, bash]
----------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-2.12.7/Open-ILS/src/sql/Pg
...
Review the <<_evergreen_2_12_7_release_notes,2.12 release notes>> for other tasks
