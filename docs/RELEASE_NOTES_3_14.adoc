...
This release contains bug fixes and documentation fixes improving on Evergreen 3.14.10.
...
We would like to thank the following individuals who contributed code, testing, documentation, and patches to the 3.14.11 point release of Evergreen:
...
The following organizations sponsored development in the 3.14.11 release of Evergreen:
...
This release contains bug fixes and documentation fixes improving on Evergreen 3.14.9.
...
We would like to thank the following individuals who contributed code, testing, documentation, and patches to the 3.14.10 point release of Evergreen:
...
The following organizations sponsored development in the 3.14.10 release of Evergreen:

* BC Libraries Cooperative

== Evergreen 3.14.9 ==

This release contains bug fixes and documentation fixes improving on Evergreen 3.14.8.
...
* Allows angular unit tests to run without OpenSRF installed. (https://bugs.launchpad.net/evergreen/+bug/2111731[Bug 2111731])
...
We would like to thank the following individuals who contributed code, testing, documentation, and patches to the 3.14.9 point release of Evergreen:
...
The following organizations sponsored development in the 3.14.9 release of Evergreen:
...
We would like to thank the following individuals who contributed code, testing, documentation, and patches to the 3.14.8 point release of Evergreen:
...
The following organizations sponsored development in the 3.14.8 release of Evergreen:
