...
+
image::media/clone-report-template-1.png[Folder Tree]
+
. Select the folder name to display the contents.
+
image::media/clone-report-template-2.png[Selected Folder]
+
...
+
image::media/clone-report-template-3.png[Clone Selected Template]
+
[TIP]
=====
...
+
image::media/clone-report-template-4.png[Select Folder]
+
...
+
image::media/clone-report-template-5.png[Save Template]
+
...
+
image::media/clone-report-template-6.png[Folder View]
