= Reporter Basics =
:page-aliases: reporter_running_recurring_reports.adoc, reporter_template_enhancements.adoc#recurring_reports, repoter_generating_reports.adoc, repoter_generating_reports.adoc#generating_reports
