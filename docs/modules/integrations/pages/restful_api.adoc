...
"Coded Value Maps - API only" (API_LOGIN, REST.api)

"Coded Value Maps - standard permissions" (OPAC_LOGIN)
...
"Search - API only" (API_LOGIN, REST.api)

"Search - standard permissions" (OPAC_LOGIN)
