...
-*Checked out*: Item is checked out to a patron account.
...
-*Reserves*: _info here from reserves module_
...
-*On reservation shelf*: _another booking module thing to insert_
...
-*On reservation shelf*: booking module

-*On order*: acquisitions
