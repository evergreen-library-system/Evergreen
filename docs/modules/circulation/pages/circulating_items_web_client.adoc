...
Throughout Evergreen, you'll find a *Strict Barcode* checkbox next to the input field.  This is used in situations when you want to make sure the system reads the full barcode and not a partial scan.  It also checks 14-digit codabar barcodes with checkdigit.
