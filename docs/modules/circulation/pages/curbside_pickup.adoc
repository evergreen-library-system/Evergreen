...
image::media/curbside_offer_email.png[Curbside offer email]

*Curbside offer SMS - example*

image::media/curbside_offer_sms.png[Curbside offer SMS]
...
image::media/curbside_confirm_email.png[Curbside confirmation email]

*Curbside confirmation SMS - example*

image::media/curbside_confirm_sms.png[Curbside confirmation SMS]
...
image::media/curbside_tbs.png[To Be Staged tab]

===== Claiming an Appointment =====

Claim

image::media/curbside_claim.png[Claim Curbside Appoinment]

Release Claim

image::media/curbside_release_claim.png[Release Curbside Appointment]

===== Potential Alerts =====

Patron arrived before appointment was Staged

image::media/curbside_patron_arrival_alert.png[Alert for Patron Has Already Arrived]
...
image::media/curbside_staged_ready.png[Staged and Ready tab]

===== Potential Alerts =====

New holds available for pickup after initial items were staged

image::media/curbside_new_holds_alert.png[Alert for holds that came in after appointment was staged]
...
image::media/curbside_patron_outside.png[Patron is Outside tab]
...
image::media/curbside_delivered_today[Delivered Today tab]
...
image::media/curbside_appointment_patron.png[Set Patron for Curbside Appointment]

image::media/curbside_appointment_time.png[Set Time for Curbside Appointment]
...
image::media/opac_set_curbside.png[Set Curbside Appointment in MyAccount]
...
image::media/opac_update_curbside.png[Update Curbside Appointment in MyAccount]
...
image::media/opac_curbside_disabled.png[Patron Curbside Appointments are Disabled]