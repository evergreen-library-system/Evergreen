...
|Metarecord        |M             |Patron or staff want first available format of a title  | Patron selects _Combine Same Title_ in public catalog search, then chooses format options under _Select desired format(s)_ from the _Place Hold_ screen. Staff selects _Group Formats/Editions in the staff catalog search, then selects format options on the _Place Hold_ screen. | Patron or staff | Holdings beloging to multiple bibliographic (title) records sharing a metarecord
...
|Issuance        |I              |Patron or staff want a specific serials issue |Staff or patron clicks on _Place Hold_ next to title. |Patron or staff |A single serials issue
