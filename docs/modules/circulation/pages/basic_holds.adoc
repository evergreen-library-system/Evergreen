...
+
image::basic_holds/PlaceHold-2.JPG[]
+
...
+
image::basic_holds/PlaceHold-3.JPG[]
+
...
+
image::basic_holds/PlaceHold-4.JPG[]
+
6. Click the row of the desired patron account, and click *Select*.
+
image::basic_holds/PlaceHold-5.JPG[]
+
...
+
image::basic_holds/holds-pull-2.png[holds-pull-2]
+
[NOTE]
===========
...
image::basic_holds/custom_hold_pickup_location2.jpg[OPAC Account]
