...
image::images/cataloging/record_buckets/buckets_interface.png[Buckets interface]
...
+
image::images/cataloging/record_buckets/bucket_sharing.png[Current share members]
+
...
+
image::images/cataloging/record_buckets/patron_search_share.png[Searching & adding new share members]
+
...
+
image::images/cataloging/record_buckets/update_sharing.png[Updating bucket sharing]
+
...
+
image::images/cataloging/record_buckets/remove_share.png[Remove user from sharing]
+
...
+
image::images/cataloging/record_buckets/library_share.png[Share with libraries]
+
** To complete your updates, select _Update Bucket Sharing_.
...
image::images/cataloging/record_buckets/upload_to_bucket.png[Upload Records to bucket]
...
image::images/cataloging/record_buckets/report_output_to_bucket.png[Bucket output options in the Reports interface]
...
image::images/cataloging/record_buckets/staffcat_favorites.png[Buckets subtab in staff catalog showing favorite buckets and recently viewed buckets]
...
image::images/cataloging/record_buckets/search_results.png[Add a record to a bucket from an individual member of the search results list]
...
image::images/cataloging/record_buckets/bibs_in_a_bucket.png[Individual record bucket view]
...
* _Move Selected Records to a Different Bucket - this will move selected records from the current bucket into a new or existing bucket for which you have edit permissions
...
+
* _Title Proper (normalized) - the title of the bibliographic record. It is a hyperlink, and clicking it will take you to the record detail view for that bibliographic record. This will open in the same tab.
...
* _Author (normalized) - the author of the bibliographic record
...
* _Record Creation Date/Time - the creation date of the bibliographic record
* _Last Edit Date/Time - the date the bibliographic record was last edited
...
+
. You can edit the lead record before you overlay the target. To edit the record, select _Edit Z39.50 Record above the lead record.
