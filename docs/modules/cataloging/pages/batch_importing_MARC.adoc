...
|Age Hold Protection|| Name of the rule to apply e.g. '6month'
...
|Deposit ||
|Deposit Amount ||
|Fine Level|| 1, 2, or 3, corresponding with low, medium, or high fines. Default is 2.
|Floating Group || Name of the floating group to apply. e.g. 'Everywhere'
|Holdable ||
|Item Number ||
|Loan Duration || 1, 2, or 3, corresponding with short, medium, or long duration. Default is 2.
|Mint Condition ||
