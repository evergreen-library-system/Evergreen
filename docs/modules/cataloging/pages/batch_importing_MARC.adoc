...
. Click *Save*.
+
image::batch_importing_MARC/new_record_match.jpg
...
match point.
+
image::batch_importing_MARC/record_attribute.jpg
...
+
image::batch_importing_MARC/operator.jpg
...
. Click *Add to Selected Node*.  Once this is selected, the tree will refresh and update with the new expression.
+
image::batch_importing_MARC/marc_tag_and_subfield.jpg
...
+
image::batch_importing_MARC/replace_node.jpg
...
. Click *Add*.
+
image::batch_importing_MARC/match_set_quality.jpg
...
+
image::batch_importing_MARC/import_record.jpg
