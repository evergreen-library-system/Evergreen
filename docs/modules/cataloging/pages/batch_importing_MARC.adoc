...
image::batch_importing_MARC/record__display_attributes.jpg[Record Display Attributes]
...
image::media/import_item_attribute_definition.png[New Import Item Attribute Definition]
