...
image::media/Conjoined_PV_Original.png[Menu: Patron View Original Record]
...
image::media/Conjoined_PV_Linked.png[Menu: Patron View Linked Record]
...
+
image::media/Conjoined_step_1.png[Menu: Mark as Target for Conjoined Items]
...
+
image::media/Conjoined_step_6.png[Conjoined step 6]
...
+
image::media/Conjoined_step_8.png[Conjoined step 8]
...
+
image::media/Conjoined_scenario_2_step_4.png[Link as Conjoined] 

5. A pop-up will appear with a dropdown menu. Choose the *Peer Type* for the conjoined item, then click *OK*.
+
image::media/Conjoined_scenario_2_step_5.png[Conjoined peer type]
...
image::media/Conjoined_unlink.png[Menu: Unlink Item]
