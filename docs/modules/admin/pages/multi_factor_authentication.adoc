...
image::images/multi_factor_authentication/TOTP_login.png[Using TOTP via a third party application]
...
image::images/multi_factor_authentication/webauthn_login.png[Enable WebAuthn device]
...
image::images/multi_factor_authentication/TOTP_email_login.png[Using TOTP via email]

image::images/multi_factor_authentication/TOTP_SMS_login.png[Using TOTP via SMS]
...
image::images/multi_factor_authentication/mfa_location.png[Location of MFA in the upper-right hamburger menu]

An example of this for a WebAuthn device is shown below.

image::images/multi_factor_authentication/edit_factors.png[Add additional, remove, or edit a WebAuthn factor]
...
image::images/multi_factor_authentication/remove_factor.png[Remove a factor for another user]
...
image::images/multi_factor_authentication/enable_mfa.png[MFA options in the Permission Groups interface]
...
image::images/multi_factor_authentication/perm_editor_mfa.png[Enabling or disabling specific MFA factors in a Permission Group]
