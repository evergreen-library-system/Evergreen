...
image::emgerency_closing/ECHLibraryClosingConstruction.png[Create Closing for One Full Day]
...
image::emgerency_closing/ECHLibraryClosingMultipleDays.png[Create Closing for Multiple Days]

image::emgerency_closing/ECHLibraryClosingDetailed.png[Create Detailed Closing]
...
image::emgerency_closing/ECHClosingSnowDay.png[Create Emergency Closing]
...
image::emgerency_closing/ECHLibraryClosingDone.png[Emergency Closing Processing Complete]
...
image::emgerency_closing/ECHEditClosing.png[Edit Closing]
