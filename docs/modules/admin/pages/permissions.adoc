...
. Click on the permission entry, click the Actions menu, and then click Edit Selected.
+
...
+
image::permissions/permissions_record_editor.png[Permission entry record editor]
+
