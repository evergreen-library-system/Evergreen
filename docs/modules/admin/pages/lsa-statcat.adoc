...
To edit or delete the individual entries for a stat cat, click on the *Entries* link to open the Entries table and follow the same steps as editing or deleting the statistical category.
