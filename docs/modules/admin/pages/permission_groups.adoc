...
image:://permission_groups/default_permission_group_tree.png[Permission groups tree]
...
image::permission_groups/inherited_permissions.png[Inherited permissions]
