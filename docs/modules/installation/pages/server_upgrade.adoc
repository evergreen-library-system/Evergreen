...
== Software Prerequisites ==
  ...
  * **Linux**: Evergreen 3.13.11 has been tested on Debian Buster
...
. As the *opensrf* user, download and extract Evergreen 3.13.11:
+
[source, bash]
-----------------------------------------------
wget https://evergreen-ils.org/downloads/Evergreen-ILS-3.13.11.tar.gz
tar xzf Evergreen-ILS-3.13.11.tar.gz
-----------------------------------------------
+
[NOTE]
...
[source, bash]
---------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.13.11
---------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.13.11/Open-ILS/examples/apache/eg_startup /etc/apache2/eg_startup
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.13.11/Open-ILS/examples/apache/eg_vhost.conf /etc/apache2/eg_vhost.conf
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.13.11/Open-ILS/examples/apache/eg.conf /etc/apache2/sites-available/eg.conf
----------------------------------------------------------
...
[source, bash]
----------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.13.11/Open-ILS/src/sql/Pg
psql -U evergreen -h localhost -f version-upgrade/3.13.10-3.13.11-upgrade-db.sql evergreen
----------------------------------------------------------
