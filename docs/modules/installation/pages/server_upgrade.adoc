...
== Software Prerequisites ==
  ...
  * **Linux**: Evergreen 3.10.0 has been tested on Debian Buster
...
. As the *opensrf* user, download and extract Evergreen 3.10.0:
+
[source, bash]
-----------------------------------------------
wget https://evergreen-ils.org/downloads/Evergreen-ILS-3.10.0.tar.gz
tar xzf Evergreen-ILS-3.10.0.tar.gz
-----------------------------------------------
+
[NOTE]
...
------------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.10.0
make STAFF_CLIENT_STAMP_ID=rel_3.10.0 install
------------------------------------------------------------
+
...
rm server
ln -sf rel_3.10.0/server server
------------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.10.0/Open-ILS/examples/apache/eg_startup /etc/apache2/eg_startup
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.10.0/Open-ILS/examples/apache/eg_vhost.conf /etc/apache2/eg_vhost.conf
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.10.0/Open-ILS/examples/apache/eg.conf /etc/apache2/sites-available/eg.conf
----------------------------------------------------------
...
[source, bash]
----------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.10.0/Open-ILS/src/sql/Pg
psql -U evergreen -h localhost -f version-upgrade/3.9.0-3.10.0-upgrade-db.sql evergreen
----------------------------------------------------------
