...
== Software Prerequisites ==
  ...
  * **Linux**: Evergreen 3.17-beta2 has been tested on Debian Buster
    (10.0), Debian Bullseye (11.0), Debian Bookworm (12.0),
    Debian Trixie (13.0), Ubuntu Jammy Jellyfish (22.04), and
    Ubuntu Noble Numbat (24.04). If you are running an older version
...
* **OpenSRF**: The minimum supported version of OpenSRF is 3.3.3.
...
. As the *opensrf* user, download and extract Evergreen 3.17-beta2:
+
[source, bash]
-----------------------------------------------
wget https://evergreen-ils.org/downloads/Evergreen-ILS-3.17-beta2.tar.gz
tar xzf Evergreen-ILS-3.17-beta2.tar.gz
-----------------------------------------------
+
[NOTE]
...
[source, bash]
---------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.17-beta2
---------------------------------------------
+
...
+
  ...
  * `debian-trixie` for Debian Trixie (13.0)
...
[source, bash]
------------------------------------------------------------
NO_CPAN_TEST=1 make -f Open-ILS/src/extras/Makefile.install [distribution]
------------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.17-beta2/Open-ILS/examples/apache/eg_startup /etc/apache2/eg_startup
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.17-beta2/Open-ILS/examples/apache/eg_vhost.conf /etc/apache2/eg_vhost.conf
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.17-beta2/Open-ILS/examples/apache/eg.conf /etc/apache2/sites-available/eg.conf
----------------------------------------------------------
...
[source, bash]
----------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.17-beta2/Open-ILS/src/sql/Pg
psql -U evergreen -h localhost -f version-upgrade/3.17-beta-3.17-beta2-upgrade-db.sql evergreen
----------------------------------------------------------
