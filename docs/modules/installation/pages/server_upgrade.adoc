...
== Software Prerequisites ==
  ...
  * **Linux**: Evergreen 3.7-beta has been tested on Debian Stretch
...
. As the *opensrf* user, download and extract Evergreen 3.7-beta:
+
[source, bash]
-----------------------------------------------
wget https://evergreen-ils.org/downloads/Evergreen-ILS-3.7-beta.tar.gz
tar xzf Evergreen-ILS-3.7-beta.tar.gz
-----------------------------------------------
+
[NOTE]
...
[source, bash]
---------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.7-beta
---------------------------------------------
+
...
------------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.7-beta
make STAFF_CLIENT_STAMP_ID=rel_3_7_beta install
------------------------------------------------------------
+
...
rm server
ln -sf rel_3_7_beta/server server
------------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.7-beta/Open-ILS/examples/apache/eg_startup /etc/apache2/eg_startup
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.7-beta/Open-ILS/examples/apache/eg_vhost.conf /etc/apache2/eg_vhost.conf
----------------------------------------------------------
+
...
[source, bash]
----------------------------------------------------------
cp /home/opensrf/Evergreen-ILS-3.7-beta/Open-ILS/examples/apache/eg.conf /etc/apache2/sites-available/eg.conf
----------------------------------------------------------
...
[source, bash]
----------------------------------------------------------
cd /home/opensrf/Evergreen-ILS-3.7-beta/Open-ILS/src/sql/Pg
psql -U evergreen -h localhost -f version-upgrade/3.6.2-3.7-beta-upgrade-db.sql evergreen
----------------------------------------------------------
