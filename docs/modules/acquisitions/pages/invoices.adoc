...
* _Payment Method_ (optional) - Select a payment method. Payment methods are set in xref:acquisitions_admin.html#_invoice_payment_method[Acquisitions Administration].
