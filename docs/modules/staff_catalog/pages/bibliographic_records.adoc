...
image:staff_catalog/show_search_form.png[Screenshot of the Show Search Form button, as described above.]
====
...
image:staff_catalog/record_summary.png[Screenshot of the Record Summary for Ready Player One containing the information described above.]
...
image:staff_catalog/results_navigation.png[Screenshot of a bibliographic record with the Results Navigation buttons highlighted, as described above.]
...
image:staff_catalog/record_actions.png[Screenshot of a record summary with the record actions buttons highlighted, as described above.]
...
image:staff_catalog/record_tabs.png[Screenshot of a bibliographic record with the record views list highlighted, as described above. The tabs appear in the order they are listed below.]
...
image:staff_catalog/delete_note.png[Screenshote showing the Delete Selected button, as described above.]
...
image:staff_catalog/hold_action.png[Screenshot of the hold actions menu, as described above.]
...
image:staff_catalog/part_actions.png[Screenshot of the Monograph Parts tab with the parts actions menu highlighted, as described above.]
...
image:staff_catalog/holdings_actions.png[Screenshot of the Holdings View with the actions menu displayed, as described above.]
...
image:staff_catalog/grid_options.png[Screenshot of the Record Notes view with the grid options buttons highlighted, as described above.]
...
image:staff_catalog/grid_actions.png[Screenshot of the Record Notes view with the Actions button highlighted. The Actions button is located above the table, in the group of buttons to the right. It is the left-most button in that group.]

=== Navigating Grids ===

There are four buttons that help you see different results and navigate through the results. 

image:staff_catalog/navigating_grids.png[The second, third, fourth, and fifth grid options buttons highlighted.]
...
image:staff_catalog/expand_vert.png[Screenshot of the grid options buttons with the down caret button highlighted, which is secod from the right.]

To access more grid options, select the gear button. A menu opens.

image:staff_catalog/grid_options_menu.png[Screenshot showing the gear button selected, as described above. The menu is descibed below.]
...
image:staff_catalog/column_selections.png[Screenshot of the grid view options menu with the column names highlighted, as described above.]
...
image:staff_catalog/sort_grid.png[Screenshot of a grid showing notes sorted as described above. The Note column has a down arrow beside it and is highlighted.]
****
