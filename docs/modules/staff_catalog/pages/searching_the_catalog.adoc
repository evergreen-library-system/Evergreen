...
The _Library Selector_ is located in the top-right corner of the search form on the Staff Catalog page. This selector allows you to change your search library to the consortium, system, branch, or other organization of your choice. If configured, it will also allow you to select Library Groups and Shelving Location Groups.

image::searching_the_catalog/lassos_and_slg.png[The Staff Catalog page showing the Library Group dropdown.]
