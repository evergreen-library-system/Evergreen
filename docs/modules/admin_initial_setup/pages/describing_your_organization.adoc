...
NOTE: There is a current bug for the DELETE_ORG_ADDRESS permission where it is not required to delete an address. To delete an address, only the UPDATE_ORG_UNIT permission is needed at this time.
