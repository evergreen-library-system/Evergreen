...
[NOTE]
==========
To protect patron privacy, the Check Out History will be completely blank unless the patron has previously opted in under the _Account Preferences_ tab, in the _Other Settings_
area.
==========
...
If you would like for only the holds that are available, or ready for pickup, to appear in the table, click the checkbox next to _Show only items available_ and click _Refresh holds list_.
...
Each of these actions can be performed for individual items by selecting the button(s) in the _Edit_ column of the hold row, or, they can be completed in a batch by selecting one or more holds and selecting the button options under the _Items on Hold_ page title.
...
. Click the _Edit_ button located in the _Edit_column of the hold row.
...
[NOTE]
==========
To protect patron privacy, the Holds History will be completely blank unless the patron has previously opted in under the _Account Preferences_ tab, in the _Other Settings_
area.
==========
...
*Notification*, *Other Settings*, and *Lists*. 
...
your account. In the _Other Settings_ tab
