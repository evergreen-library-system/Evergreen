...
image::using_the_public_access_catalog/search_facets.jpg[search facets]
...
image::using_the_public_access_catalog/search_result_quantity.jpg[search result quantity]
