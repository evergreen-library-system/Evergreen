dump('entering admin.transit_list2.js\n');

if (typeof admin == 'undefined') admin = {};
admin.transit_list2 = function (params) {
			...
			{ 
				...
				'on_select' : function(ev) {
					try {
						...
						obj.error.sdump('D_TRACE','admin.transit_list2: selection list = ' + js2JSON(obj.selection_list) );
...
dump('exiting admin.transit_list2.js\n');
