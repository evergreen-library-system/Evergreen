--Upgrade Script for 3.10.2 to 3.10.3
\set eg_version '''3.10.3'''
BEGIN;
INSERT INTO config.upgrade_log (version, applied_to) VALUES ('3.10.3', :eg_version);

INSERT INTO config.upgrade_log (version, applied_to) VALUES ('1379', :eg_version);
