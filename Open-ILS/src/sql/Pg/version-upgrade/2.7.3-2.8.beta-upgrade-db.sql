--Upgrade Script for 2.7.3 to 2.8.beta
\set eg_version '''2.8.beta'''

BEGIN;

INSERT INTO config.upgrade_log (version, applied_to) VALUES ('2.8.beta', :eg_version);
...
-- run these outside the main transaction
