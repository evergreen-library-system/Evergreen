...
ALTER TABLE biblio.record_data ADD CONSTRAINT record_data_owner_doc_fkey FOREIGN KEY ( owner_doc ) REFERENCES biblio.record_entry (id) ON DELETE CASCADE;
...
ALTER TABLE biblio.record_note ADD CONSTRAINT record_note_record_fkey FOREIGN KEY ( record ) REFERENCES biblio.record_entry (id) ON DELETE CASCADE;

ALTER TABLE biblio.record_mods ADD CONSTRAINT record_mods_record_fkey FOREIGN KEY ( id ) REFERENCES biblio.record_entry (id) ON DELETE CASCADE;
