...
ALTER TABLE metabib.metarecord_source_map ADD CONSTRAINT title_field_entry_source_map_source_record_fkey FOREIGN KEY ( source ) REFERENCES biblio.record_entry (id) ON DELETE RESTRICT;
