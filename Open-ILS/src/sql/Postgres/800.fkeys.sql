...
ALTER TABLE actor.usr ADD CONSTRAINT actor_usr_class_fkey FOREIGN KEY (class) REFERENCES actor.class (id);
...
ALTER TABLE metabib.record_descriptor ADD CONSTRAINT metabib_record_descriptor_record_fkey FOREIGN KEY (record) REFERENCES biblio.record_entry (id);

ALTER TABLE metabib.full_rec ADD CONSTRAINT metabib_record_descriptor_record_fkey FOREIGN KEY (record) REFERENCES biblio.record_entry (id);
...
ALTER TABLE asset.copy_note ADD CONSTRAINT asset_copy_note_editor_fkey FOREIGN KEY (editor) REFERENCES actor.usr (id);
...
ALTER TABLE asset.call_number_note ADD CONSTRAINT asset_call_number_note_editor_fkey FOREIGN KEY (editor) REFERENCES actor.usr (id);
