...
* xref:docs:shared:workstation_settings.adoc[Configuring Evergreen for Your
Workstation]
* xref:docs:acquisitions:introduction.adoc[Acquisitions]
* xref:docs:acquisitions:selection_lists_po.adoc[Selection Lists and Purchase
Orders]
* xref:docs:acquisitions:vandelay_acquisitions_integration.adoc[Load MARC Order
Records]
* xref:docs:acquisitions:invoices.adoc[Invoices]
* xref:docs:acquisitions:receive_items_from_invoice.adoc[]
* xref:docs:acquisitions:purchase_requests_management.adoc[Managing Patron
Purchase Requests]
* xref:docs:acquisitions:purchase_requests_patron_view.adoc[]
* xref:docs:opac:using_the_public_access_catalog.adoc[Using the Public Access
Catalog]
